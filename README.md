...
excerpt: "Basic usage overview MLNBoostDB.<br/> Extension of Marcin's code on database integrated MLN-Boost. <br/> A wrapper ensures same command line argument structure as MLN-Boost."
---
